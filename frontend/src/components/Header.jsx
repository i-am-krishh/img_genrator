...
const Header = () => {
  ...
  return (
    <motion.div
      className="flex flex-col justify-center items-center text-center my-15"
    ...
    >
      ...
      {/* ends here  */}
      {/* Heading  */}
      <motion.h1 className="text-4xl lg:max-w-[650px] sm:text-7xl sm:max-w-[700px] md:max-w-[600px]">
        Trun text to{" "}
        <span
      ...
      >
        Unleash your creativity with AI. Turn your Imagination into visual arts
      ...
      >
        Generated images with PromptPixel
      </motion.p>
    </motion.div>
  );
};
